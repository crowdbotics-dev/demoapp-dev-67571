...
function modules_social_auth_facebook_login_create(payload) {
  return demoappdevAPI.post(`/modules/social-auth/facebook/login/`, payload.data);
}

function modules_social_auth_google_connect_create(payload) {
  return demoappdevAPI.post(`/modules/social-auth/google/connect/`, payload.data);
}
...
function rest_auth_registration_verify_email_create(payload) {
  return demoappdevAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}

function modules_social_auth_facebook_connect_create(payload) {
  return demoappdevAPI.post(`/modules/social-auth/facebook/connect/`, payload.data);
}

function modules_social_auth_socialaccounts_disconnect_create(payload) {
  return demoappdevAPI.post(`/modules/social-auth/socialaccounts/${payload.id}/disconnect/`, payload.data);
}
