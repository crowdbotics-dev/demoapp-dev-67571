...
export const currentweatherapi_get_currentjson_list = createAsyncThunk("currentweatherapi_response_get_CurrentWeathers/currentweatherapi_get_currentjson_list", async payload => {
  const response = await apiService.currentweatherapi_get_currentjson_list(payload);
