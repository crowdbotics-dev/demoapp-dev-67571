...
const GettingStarted = ({
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      flex: 1
          ...
          <Pressable onPress={{}}><View style={styles.rSmptqdo}></View></Pressable><ImageBackground style={styles.GVdEmvKN} source={{
      ...
      }} resizeMode="cover"></ImageBackground><RadioGroup style={styles.rKWWKiBy} radioButtons={[{
        id: "1",
        label: "Option 1",
        value: "option1"
      }, {
        ...
        label: "Option 2",
        value: "option2"
      }]} layout="column"></RadioGroup><CheckBox style={styles.MKxWIVYH} title="Checkbox Title"></CheckBox><Slider style={styles.GnTLTLzw} thumbStyle={{
        height: 20,
        width: 20
